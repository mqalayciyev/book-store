...
@section('title', __('admin.User Manager'))
@section('head')
...
@if (@$manage == 2)
    ...
    @else
        ...
        @endphp
    @endif
    <form action="{{ route('manage.user.save', @$entry->id) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <section class="content-header">
            <h1 class="pull-left">@lang('admin.User')</h1>
            <div class="pull-right">
                @if($entry->id>0)
                    <a href="{{ route('manage.user.new') }}"
                       class="btn btn-success"> @lang('admin.Add New User')</a>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="mobile"
                                                               ...
                                                               name="mobile"
                                                               value="{{(auth('manage')->user()->is_manage == 2) ? '' : old('mobile', $entry->mobile)  }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="email"
                                                               placeholder="Email"
                                                               name="email"
                                                               value="{{(auth('manage')->user()->is_manage == 2) ? '' : old('mobile', $entry->email)  }}">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-at"></i>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="phone"
                                                               ...
                                                               data-mask=""
                                                               value="{{(auth('manage')->user()->is_manage == 2) ? '' : old('mobile', $entry->phone)  }}">
                                                        <div class="input-group-addon">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="country"
                                                           ...
                                                           name="country"
                                                           value="{{ old('country', $entry->detail->country) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="state"
                                                           ...
                                                           name="state"
                                                           value="{{ old('state', $entry->detail->state) }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="city"
                                                           ...
                                                           name="city"
                                                           value="{{ old('city', $entry->detail->city) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="zip_code"
                                                           ...
                                                           name="zip_code"
                                                           value="{{ old('zip_code', $entry->detail->zip_code) }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
