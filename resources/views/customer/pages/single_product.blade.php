            ...
            <div class="product product-single card">
                ...
                <div class="product-body">
                    ...
                    <div class="product-btns">
                        @auth
                        <button type="button" class="main-btn icon-btn add-wish-list" data-id="{{ $product->id }}"><i
                            class="fa fa-heart"></i></button>
                        @endauth
                        <button class="main-btn icon-btn add-to-compare" data-id="{{ $product->id }}"><i
                                class="fa fa-exchange"></i></button>
                        <input type="hidden" name="id" value="{{ $product->id }}">
                        <button type="submit" class="primary-btn add-to-cart" data-stok="{{ $product->stok_piece }}"
                            id="{{ $product->id }}">
